...
`e3r diff` should refuse strict comparisons when protocol hashes differ. A loose comparison mode may be allowed, but it should label the result as non-strict.
