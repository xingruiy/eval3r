...
recorded as overrides (they change the protocol hash, so overridden runs are never
silently comparable to un-overridden ones).
...
result = evaluate_depth(
    ...
    align="scale_median", align_granularity="per_frame",
