...
def command(
    ...
    gt_root: Annotated[str, typer.Option("--gt-root", help="DTU dataset root.")] = ...,  # type: ignore[assignment]
    ...
    cfg = DTUBenchmarkConfig(
        sampler=sampler,
        aligner=aligner,
        metrics=list(metrics or ["chamfer", "fscore@1.0", "fscore@2.0", "fscore@5.0"]),
        samples=samples,
        seed=seed,
